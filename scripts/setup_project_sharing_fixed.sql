...
-- 4. Устанавливаем owner_id для существующих проектов (используем первого пользователя)
-- ВАЖНО: Замените UUID на ID вашего пользователя, если знаете его
UPDATE projects 
SET owner_id = (
...
-- 12. Создаем функцию для приглашения пользователя
