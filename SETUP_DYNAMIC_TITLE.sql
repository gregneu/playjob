-- Настройка динамического заголовка вкладки браузера
...
-- Если у пользователя назначено 3 тикета в проекте "Мой проект", 
-- заголовок вкладки будет: "(3) Мой проект"
-- Если тикетов нет, заголовок будет: "Мой проект"
